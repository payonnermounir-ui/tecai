...
export default function App() {
  ...
  async function ensureUserRow(emailValue: string, referredBy?: string) {
    ...
    if (!existingUser) {
      await createUser(normalizedEmail, "local_user", normalizedRef || undefined);
    }
  ...
  async function handleAuthSubmit() {
    ...
    if (authMode === "register") {
      ...
      if (signIn.error) return setNotice(signIn.error.message);
      ...
      await ensureUserRow(safeEmail, referredBy);
