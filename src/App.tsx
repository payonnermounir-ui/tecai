  ...
  async function handleAuthSubmit() {
    ...
    try {
      ...
      if (authMode === "register") {
        ...
        if (!userReady) {
          setNotice(lang === "ar" ? "تعذر حفظ الحساب في جدول المستخدمين" : "Failed to save user row");
          return;
        }
    ...
    return (
      <div className="min-h-screen bg-zinc-100 p-4" dir={lang === "ar" ? "rtl" : "ltr"}>
        <div className="mx-auto max-w-3xl space-y-4">
          ...
          {isBusy && <p className="rounded-xl bg-amber-50 p-2 text-center text-xs text-amber-700">{lang === "ar" ? "جاري التحديث... يرجى الانتظار" : "Updating... please wait"}</p>}
