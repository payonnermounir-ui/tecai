...
export default function App() {
  ...
  async function handleAuthSubmit() {
    ...
    // Admin login must have a valid Supabase session to run admin RPC operations.
  ...
  async function handleBuy(plan: (typeof PRODUCTS)[number]) {
    ...
    // Preferred secure path: server-side atomic purchase RPC.
    ...
    // Fallback path for old DB setup.
